...
(sc_array_t * face_quad_array, const sc_array_t * element_dof_array,t8dg_LGL_quadrature_t *quadrature ,t8dg_LGL_functionbasis_t *functionbasis);
void t8dg_LGL_transform_face_quad_to_element_dof
(sc_array_t * element_dof_array, const sc_array_t * face_quad_array ,t8dg_LGL_quadrature_t *quadrature ,t8dg_LGL_functionbasis_t *functionbasis);


void t8dg_LGL_functionbasis_apply_derivative_matrix(sc_array_t *derivative_dof_values, const sc_array_t dof_values, t8dg_LGL_functionbasis_t *functionbasis);
void t8dg_LGL_functionbasis_apply_derivative_matrix_transpose
  (sc_array_t *dof_values, const sc_array_t *derivative_dof_values, t8dg_LGL_functionbasis_t *functionbasis);
