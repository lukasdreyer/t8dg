...
void                t8dg_LGL_quadrature_and_functionbasis_new_1D (t8dg_LGL_quadrature_t ** pquadrature,
                                                                  t8dg_LGL_functionbasis_t ** pfunctionbasis, const int number_of_LGL);
 ...
 */
void                t8dg_LGL_transform_element_dof_to_face_quad (sc_array_t * face_quad_array,
                                                                 const sc_array_t * element_dof_array,
                                                                 const int iface,
                                                                 const t8dg_LGL_quadrature_t * quadrature,
...
t8dg_quad_idx_t     t8dg_LGL_functionbasis_get_num_dof (const t8dg_LGL_functionbasis_t * functionbasis);
...
*/
void                t8dg_LGL_functionbasis_get_vertex (double vertex[3], const t8dg_LGL_functionbasis_t * functionbasis, const int idof);

/** Returns the number of faces of the reference element
 * \param [in] quadrature            		quadrature
 * \return 					number of faces
 */
int                 t8dg_LGL_quadrature_get_num_faces (const t8dg_LGL_quadrature_t * quadrature);

/** Returns the number of element quadrature vertices of a quadrature
 * \param [in] quadrature            		quadrature
 * \return 					number of element quadrature vertices
 */
t8dg_quad_idx_t     t8dg_LGL_quadrature_get_num_element_vertices (const t8dg_LGL_quadrature_t * quadrature);
 ...
 * \return 					number of element quadrature vertices
 */
t8dg_quad_idx_t     t8dg_LGL_quadrature_get_num_face_vertices (const t8dg_LGL_quadrature_t * quadrature, int iface);
...
*/
void                t8dg_LGL_quadrature_get_element_vertex (double vertex[3],
                                                            const t8dg_LGL_quadrature_t * quadrature, const t8dg_quad_idx_t iquad);
 ...
 */
double              t8dg_LGL_quadrature_get_element_weight (const t8dg_LGL_quadrature_t * quadrature, const t8dg_quad_idx_t iquad);
 ...
 * \param [in] iquad            		Index of the element quadrature point
*/
void                t8dg_LGL_quadrature_get_face_vertex (double vertex[3],
                                                         const t8dg_LGL_quadrature_t * quadrature,
 ...
 * \return 					quadrature weight of the vertex
 */
double              t8dg_LGL_quadrature_get_face_weight (const t8dg_LGL_quadrature_t * quadrature,
                                                         const int iface, const t8dg_quad_idx_t iquad);
