...
void                t8dg_linear_flux3D_constant_flux_fn (double x_vec[3], double flux_vec[3], double t, void *flux_data, t8_locidx_t itree, t8_locidx_t ielement);

void                t8dg_rotating_flux_2D_fn (double x_vec[3], double flux_vec[3], double t, void *flux_data, t8_locidx_t itree, t8_locidx_t ielement);

void                t8dg_spiral_flux_3D_fn (double x_vec[3], double flux_vec[3], double t, void *flux_data, t8_locidx_t itree, t8_locidx_t ielement);

/* Implementation in t8_mptrac.cxx */
void                t8dg_mptrac_flow_3D_fn (double x_vec[3], double flux_vec[3], double t, void *flux_data, t8_locidx_t itree, t8_locidx_t ielement);
