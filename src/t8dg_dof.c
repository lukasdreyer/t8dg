...
{
  t8_locidx_t         idata = t8dg_itree_ielement_to_idata (dof_values->forest, itree, ielement);
  ...
  t8dg_dofidx_t       num_element_dof = t8dg_global_values_get_num_dof (global_values);
  element_dof_view =
