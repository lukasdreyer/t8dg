...
t8dg_functionbasis_t *t8dg_functionbasis_new_Lagrange_LGL (t8dg_vertexset_t * vertexset);
...
t8dg_functionbasis_type_t t8dg_functionbasis_get_type (t8dg_functionbasis_t * functionbasis);
